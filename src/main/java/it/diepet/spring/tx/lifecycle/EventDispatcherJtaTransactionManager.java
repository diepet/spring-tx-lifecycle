...
/**
 * The Class EventDispatcherJtaTransactionManager.
 */
public class EventDispatcherJtaTransactionManager extends JtaTransactionManager
		implements ApplicationEventPublisherAware {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 672523036231796284L;

	/** The Constant LOGGER. */
	private static final Logger LOGGER = LoggerFactory.getLogger(EventDispatcherJtaTransactionManager.class);
