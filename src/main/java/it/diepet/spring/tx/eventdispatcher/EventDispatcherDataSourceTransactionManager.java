...
/**
 * The Class EventDispatcherDataSourceTransactionManager.
 */
public class EventDispatcherDataSourceTransactionManager extends DataSourceTransactionManager
		implements ApplicationEventPublisherAware {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -5351992235387543021L;

	/** The Constant LOGGER. */
	private static final Logger LOGGER = LoggerFactory.getLogger(EventDispatcherDataSourceTransactionManager.class);
