...
/**
 * The Class EventDispatcherHibernate4TransactionManager.
 */
public class EventDispatcherHibernate4TransactionManager extends HibernateTransactionManager
		implements ApplicationEventPublisherAware {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 1991384474933890441L;

	/** The Constant LOGGER. */
	private static final Logger LOGGER = LoggerFactory.getLogger(EventDispatcherHibernate4TransactionManager.class);
