...
/**
 * The Class EventDispatcherJpaTransactionManager.
 */
public class EventDispatcherJpaTransactionManager extends JpaTransactionManager
		implements ApplicationEventPublisherAware {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 3297756287507626336L;

	/** The Constant LOGGER. */
	private static final Logger LOGGER = LoggerFactory.getLogger(EventDispatcherJpaTransactionManager.class);
